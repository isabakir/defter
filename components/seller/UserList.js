...
if(props.route.params.type=='musteri'){
  props.navigation.navigate('Siparişlerim',{seller_id:props.route.params.seller_id});
    ...
    const renderData=({item})=>{
        ...
        return(
          <View style={styles.mainContainer} >
            ...
            <TouchableOpacity style={styles.userContainer} onLongPress={()=>{ _modalOpen(item.buyyer_id,item.name);}} onPress={() =>   props.navigation.navigate('Tüm Siparişler',{userName:item.name,seller_id:props.route.params.seller_id,buyyer_id:item.buyyer_id})}>
