...
const renderData=({item,index})=>{
  ...
  return(
    ...
    <View style={styles.userContainer}>
      ...
      <TouchableOpacity style={styles.touchAble}  onPress={() =>{  props.navigation.navigate('Eski Sipariş',{buyyer_id:props.route.params.buyyer_id,userName:props.route.params.name,seller_id:props.route.params.seller_id,group_order_id:item.order_group_id,update:item.update_date,changeRender,toplamBakiye:t})}}>
    ...
    <Text style={{textAlign:'right'}}>{ t.toFixed(2)} TL Toplam Kalan</Text>
     <Button title="Yeni Sipariş" onPress={()=>{props.navigation.navigate("Sipariş",{buyyer_id:props.route.params.buyyer_id,userName:props.route.params.name,seller_id:props.route.params.seller_id,changeRender,toplamBakiye:t})}}/>
    </SafeAreaView>
        );
