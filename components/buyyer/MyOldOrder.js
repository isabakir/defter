...
class MyOldOrder extends Component{
            ...
            const orderList=Object.entries(this.state.views).map(([key,value])=>{
                  ...
                  if(value.pro_name){
                    ...
                    return(
                        ...
                        <TextInput editable={false}  onChangeText={this.ChangeName}  value={value.pro_name}  style={styles.textInput}/>
                        <TextInput editable={false}  onChangeText={this.ChangeSize}  value={value.pro_size}  style={styles.textInput}/>
                        <TextInput  editable={false} keyboardType="numeric"  style={styles.textInputAdet}  value={value.piece}  onChangeText={(text,key)=>{ this.changeAdet(text,value.id)}}/>
                        <TextInput editable={false}  keyboardType="numeric" style={styles.textInputAdet}  value={value.unit_price} onChangeText={(text,key)=>{ this.Change(text,value.id) }}/>
